    ...
    <div>
      <div>
        <button
          ...
          aria-controls="bandeja-pix"
          className={`${bgColor} text-white font-bold w-[276px] h-[60px] rounded-full flex justify-start px-2 items-center rotate-90 cursor-pointer hover:brightness-120 group transition-[filter] duration-300 shadow-md`}
        >
