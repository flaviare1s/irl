...
export const BotaoDoacoes = ({ text = 'Faça uma Doação', bgColor = 'bg-living-coral' }) => {
  ...
  return (
    <div>
      <button
        onClick={openModal}
        className={`${bgColor} text-white font-bold w-[270px] h-[60px] rounded-full flex justify-start px-2 items-center lg:rotate-90 cursor-pointer hover:brightness-120 group transition-all duration-300`}>
