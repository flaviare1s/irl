  ...
  return (
    <div>
      <div className="relative w-full h-[600px] sm:h-[650px] flex flex-col justify-center items-center m-auto">
        <img className='h-[200px] w-[200px] xl:h-[300px] xl:w-[300px] absolute top-[-40px] right-0 xl:top-[-70px] xl:right-[250px] -z-10' src={Pattern} />
        ...
        <Button rota='/programas' text='Conheça nossos projetos' />
